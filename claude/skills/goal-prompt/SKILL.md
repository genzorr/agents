...
Create a short prompt for a Claude Code session.

> **Cross-tree twin.** `codex/skills/goal-prompt/SKILL.md` is the Codex counterpart. The two
...
- Do not mention setting a goal. This skill produces the prompt for a Claude Code session to run directly.
