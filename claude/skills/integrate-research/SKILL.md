...
/integrate-research output.pdf "focus on the deployment implications"
```
...
2. Read the relevant `CLAUDE.md`, README, current docs/research/drafts, ADRs/specs, and named source or configuration. Compare research claims and citations with current documents and source evidence before deciding what carries over.
...
5. If documentation updates are already authorized, identify the affected files and apply only the in-scope changes without asking again. Otherwise report the comparison, implications, conflicts, uncertainty, and evidence gaps in chat, with proposals where useful. If ambiguity materially changes scope, use AskUserQuestion once.
