...
5. **Fix.** If there is a correct seam, turn the minimized repro into a regression test before the fix. If no seam exists, note that as an architecture/testing gap.
